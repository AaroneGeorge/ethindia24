...
export default function Home() {
  ...
  const { data: memeCoins, error } = useSWR("/api/top-meme-coins", fetcher, {
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="rounded-3xl flex flex-col items-center text-center border-2 border-black p-8 mb-8 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          ...
          <p className="text-gray-500 mb-4">
            Welcome to the meme coin marketplace!
          </p>
          <p className="mb-8 max-w-3xl">
            Explore the latest trends in meme coins, track their prices, and
            stay updated with real-time market data. Our platform provides
            comprehensive information on various meme tokens, helping you make
            informed decisions.
          </p>
          <button
